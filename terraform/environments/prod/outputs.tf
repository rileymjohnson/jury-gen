...
output "web_bucket_name" {
  description = "S3 bucket for the web app (prod)"
  value       = module.stack.web_bucket_name
}

output "web_cloudfront_domain" {
  description = "CloudFront domain for the web app (prod)"
  value       = module.stack.web_cloudfront_domain
}

output "web_cloudfront_distribution_id" {
  description = "CloudFront distribution ID for the web app (prod)"
  value       = module.stack.web_cloudfront_distribution_id
}

output "web_url" {
  description = "Public URL for the web app (prod)"
