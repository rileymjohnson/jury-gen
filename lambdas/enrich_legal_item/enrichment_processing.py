                    ...
                    "damages": {
                        ...
                        "properties": {
                            "compensatory": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "Compensatory/actual damages (e.g., '$50,000', 'lost profits', 'actual damages')",  # noqa: E501
                            },
                            "punitive": {
                                "type": "array",
                                "items": {"type": "string"},
                            ...
                            "statutory": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "Statutory damages (e.g., 'treble damages', 'statutory damages under §XYZ')",  # noqa: E501
                            },
                            "equitable": {
                                "type": "array",
                                "items": {"type": "string"},
