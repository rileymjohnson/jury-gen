                ...
                "defenses": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            "raw_text": {
                                "type": "string",
                                "description": "Exact text as it appears (e.g., 'FIRST AFFIRMATIVE DEFENSE - STATUTE OF LIMITATIONS')"
                            },
                            "name": {
                                "type": "string",
...
Also update the context paragraph to summarize what defenses you've seen so far."""
        }]
    })
                ...
                "damages": {
                    ...
                    "properties": {
                        ...
                        "equitable": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "Equitable relief (e.g., 'injunctive relief', 'specific performance', 'declaratory judgment')"
                        },
                        "other": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "Other relief (e.g., 'attorney's fees', 'costs', 'pre/post-judgment interest')"
                        }
                    },
...
Also update the context paragraph to summarize what damages you've seen so far."""
        }]
    })
...
def deduplicate_defenses(defenses: list[dict]) -> list[dict]:
                ...
                "grouped_defenses": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            "name": {
                                "type": "string",
                                "description": "Canonical name for this defense"
                            },
                            "raw_text": {
                                "type": "string",
    ...
    defenses_text = "\n".join([
        f"{i+1}. Name: {d['name']}, Raw: {d['raw_text']}"
...
- raw_text: the most complete/clear raw text variant"""
        }]
    })
...
def extract_damages_for_claim(claim_context: str, complaint_chunks: list[str], window_size: int = 3, claim_type: str = "claims") -> dict:
    ...
    for i in range(0, len(complaint_chunks), window_size - 1):
        ...
        for category in all_damages.keys():
